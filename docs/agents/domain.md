...
How the engineering skills should consume enochWIKI's domain documentation when exploring the
codebase. **Layout: single-context** — one `CONTEXT.md` + `docs/adr/` at the repo root.

## Before exploring, read these

- **`CONTEXT.md`** at the repo root (the project's shared language / glossary).
